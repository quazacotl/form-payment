...
var addButton = document.querySelector('.form__add-wrapper');
var addForm = document.querySelector('.add-form');
var successForm = document.querySelector('.success-form');
var failForm = document.querySelector('.fail-form');
var mainForm = document.querySelector('.form');
var productItems = document.querySelectorAll('.add-form__product-item');
...
var countAddedProducts = function countAddedProducts() {
  var products = document.querySelectorAll('.additional-product');
  products.forEach(function (item, i) {
    var labels = item.querySelectorAll('.form__label');
    var inputs = item.querySelectorAll('.form__input');
    item.querySelector('.form__subheader').innerText = "Product ".concat(i + 2);
    labels[0].setAttribute('for', "product-name".concat(i + 2));
    inputs[0].setAttribute('id', "product-name".concat(i + 2));
    inputs[0].setAttribute('name', "product-name".concat(i + 2));
    labels[1].setAttribute('for', "product-link".concat(i + 2));
    inputs[1].setAttribute('id', "product-link".concat(i + 2));
    inputs[1].setAttribute('name', "product-link".concat(i + 2));
  });
};

var animateIn = function animateIn(element, styleNameIn) {
  element.classList.add(styleNameIn);
  element.style.display = 'block';
};

var animateOut = function animateOut(element, styleNameIn) {
...
var countSum = function countSum() {
  switch (productCount) {
    case 1:
      formBtn.innerText = 'Submit and pay 24.99 USD';
      break;

    case 2:
      formBtn.innerText = 'Submit and pay 44 USD';
      break;

    case 3:
      formBtn.innerText = 'Submit and pay 60 USD';
      break;

    case 4:
      formBtn.innerText = 'Submit and pay 72 USD';
      break;

    case 5:
      formBtn.innerText = 'Submit and pay 80 USD';
      break;
...
var showForm = function showForm(form, pathname) {
...
addFormBtn.addEventListener('click', function () {
  var addedProducts = document.querySelectorAll('.additional-product');
  ...
  try {
    var productId = addForm.querySelector('.active-item').id;
  ...
  countSum();
  var deleteBtns = document.querySelectorAll('.additional-product__delete');
  countAddedProducts(); // Удаление элемента
